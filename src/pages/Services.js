...
const Services = () => {
  ...
  return (
    <>
      <Helmet>
        <link rel="canonical" href="https://primetalsolutions.com/services" />
      </Helmet>
      <section className="section services-section" id="services" aria-labelledby="services-heading">
        <div className="hexagon-bg" data-aos="zoom-in" data-aos-delay="100" role="presentation" />
        <div className="section-content">
          <header className="section-header" data-aos="fade-left">
            <h1 className="section-heading" id="services-heading" data-aos="fade-up" data-aos-delay="100">Our <span className="highlight">Expert</span> Solutions</h1>
          ...
          <div className="services-grid" role="list" aria-label="Service Offerings">
            <article className="service-card" data-aos="fade-up" data-aos-delay="100" role="listitem">
              <div className="hexagon-icon" data-aos="zoom-in" data-aos-delay="200" aria-hidden="true">
            ...
            <article className="service-card" data-aos="fade-up" data-aos-delay="200" role="listitem">
              <div className="hexagon-icon" data-aos="zoom-in" data-aos-delay="300" aria-hidden="true">
                <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
            ...
            <article className="service-card" data-aos="fade-up" data-aos-delay="300" role="listitem">
              <div className="hexagon-icon" data-aos="zoom-in" data-aos-delay="400" aria-hidden="true">
                <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
            ...
            <article className="service-card" data-aos="fade-up" data-aos-delay="400" role="listitem">
              <div className="hexagon-icon" data-aos="zoom-in" data-aos-delay="500" aria-hidden="true">
                <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
