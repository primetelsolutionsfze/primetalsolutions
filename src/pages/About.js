    ...
    <>
      ...
      <section className="section about-section" id="about" aria-labelledby="about-heading">
        ...
        <div className="section-content">
          <header className="section-header" data-aos="fade-right">
            <h1 className="section-heading" id="about-heading" data-aos="fade-up" data-aos-delay="100">About <span className="gradient-text">Primetel</span></h1>
          ...
          <div className="about-grid" role="list" aria-label="About Primetel">
            <article className="about-card" data-aos="flip-left" data-aos-delay="100" role="listitem">
              <div className="circle-icon" data-aos="zoom-in" data-aos-delay="200" aria-hidden="true">
            ...
            <article className="about-card" data-aos="flip-up" data-aos-delay="200" role="listitem">
              <div className="circle-icon" data-aos="zoom-in" data-aos-delay="300" aria-hidden="true">
                <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
            ...
            <article className="about-card" data-aos="flip-right" data-aos-delay="300" role="listitem">
              <div className="circle-icon" data-aos="zoom-in" data-aos-delay="400" aria-hidden="true">
                <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
